...
template <typename T>
void
deleteMapElements(T *map)
{
    for (typename T::iterator it = map->begin(),
            et = map->end();
            it != et; ++it) {
        delete it->second;
    }
...
template <typename T>
bool
isEqualTo(T *container1, T *container2)
{
...
template <typename T>
bool
isEqualToIter(T iter1_begin, T iter1_end, T iter2_begin, T iter2_end)
{
...
template <typename T>
void
push_back2(T *container, const typename T::value_type &val1,
