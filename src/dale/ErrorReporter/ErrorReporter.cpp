...
void
ErrorReporter::addError(Error *err)
{
...
int
ErrorReporter::getErrorTypeCount(int error_type)
{
    int total = 0;
...
void
ErrorReporter::popErrors(int original_count)
{
...
bool
ErrorReporter::assertIsIntegerType(const char *form_name,
                                   Node *n, Type *type,
...
bool
ErrorReporter::assertIsPointerOrIntegerType(const char *form_name,
                                            Node *n, Type *type,
                                            const char *arg_number)
{
...
bool
ErrorReporter::assertIsPointerType(const char *form_name,
                                   Node *n, Type *type,
                                   const char *arg_number)
{
    if (type->points_to) {
...
bool
ErrorReporter::assertAtomIsStringLiteral(const char *form_name,
                                         Node *n, const char *arg_number)
{
...
bool
ErrorReporter::assertArgIsAtom(const char *form_name, Node *n,
                               const char *arg_number)
{
    if (n->is_token) {
        return true;
...
bool
ErrorReporter::assertArgIsList(const char *form_name,
                               Node *n, const char *arg_number)
{
    if (n->is_list) {
        return true;
...
bool
ErrorReporter::assertAtomIsSymbol(const char *form_name,
                                  Node *n, const char *arg_number)
{
